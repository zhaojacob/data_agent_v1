...
def import_all_batches(use_local: bool = True):
    """
    导入所有批次数据
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='一次性批量导入所有历史新闻数据')
    ...
    import_all_batches(use_local=not args.cloud)
